...
function customPwdCheck(_pwd, _id) {
      ...
      function checkSequentialPattern(_pwd) {
        ...
        var patternArr = [
            numPattern
            , keyboardSeqPattern1
            , keyboardSeqPattern1.split("").reverse().join("")
            , keyboardSeqPattern2
            , keyboardSeqPattern2.split("").reverse().join("")
            , keyboardSeqPattern3
            , keyboardSeqPattern3.split("").reverse().join("")
            , keyboardSeqPattern4
            , keyboardSeqPattern4.split("").reverse().join("")
            , keyboardSeqPattern5
            , keyboardSeqPattern5.split("").reverse().join("")
            , keyboardSeqPattern6
            , keyboardSeqPattern6.split("").reverse().join("")
            , keyboardSeqPattern7
            , keyboardSeqPattern7.split("").reverse().join("")
            , keyboardSeqPattern8
            , keyboardSeqPattern8.split("").reverse().join("")
          ];

        var msgArr = [
            '비밀번호는 012처럼 연속된 숫자를 입력할 수 없습니다.'
