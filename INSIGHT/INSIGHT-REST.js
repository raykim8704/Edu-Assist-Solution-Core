...
///Q&A 수정하기 (POST - /event/{이벤트번호}/class/{클래스번호}/qna/put/{qna번호}

INSIGHT.REST.modifyQna = function ( params, eventNumber, classNum, qnum, token ) {
	var url = INSIGHT.serviceURL + "event/" + eventNumber + "/class/" + classNum + '/qna/put/' + qnum;
	var data = params;
	return _post( url, token, data );
}
//Q&A 삭제하기 (POST - /event/{이벤트번호}/class/{클래스번호}/qna/delete/{qna번호 배열}
INSIGHT.REST.deleteQna = function ( eventNumber, classNum, qnum, token ) {

	var url = INSIGHT.serviceURL + "event/" + eventNumber + "/class/" + classNum + '/qna/delete/' + qnum;
	var data = {};
	return _post( url, token, data );
}

//(POST - /event/{이벤트번호}/class/{클래스번호}/qna/{qna번호}/like
...
//(GET - /event/{이벤트번호}/qna/{qna번호}/comment


INSIGHT.REST.getQnaCommnets = function ( token, eventNumber, classNum, qnum ) {
	var url = INSIGHT.serviceURL + "event/" + eventNumber + "/qna/" + qnum + "/comment";
	return _get( url, token );
}


//댓글 달기 (POST - /event/{이벤트번호}/class/{클래스번호}/qna/{qna번호}/comment

INSIGHT.REST.registComment = function ( eventNumber, classNum, qnum, token, comment ) {

	var url = INSIGHT.serviceURL + "event/" + eventNumber + '/qna/' + qnum + '/comment';
	return _post( url, token, comment );
}

// 댓글 삭제하기 (POST - /event/{이벤트번호}/class/{클래스번호}/qna/{qna번호}/comment/delete/{코멘트번호}

INSIGHT.REST.deleteComment = function ( token, eventNumber, classNum, qnum, cnum ) {

	var url = INSIGHT.serviceURL + "event/" + eventNumber + "/class/" + classNum + '/qna/' + qnum + '/comment/delete/' + cnum;
	var data = {};
	return _post( url, token, data );
}
